 ...
 */
#if ANY(HAS_Z_SERVO_PROBE, FIX_MOUNTED_PROBE, NOZZLE_AS_PROBE, TOUCH_MI_PROBE, Z_PROBE_ALLEN_KEY, Z_PROBE_SLED, SOLENOID_PROBE, SENSORLESS_PROBING, RACK_AND_PINION_PROBE) || (MOTHERBOARD == BOARD_SNAPMAKER_2_0)
  ...
  #endif
  #if DISABLED(SW_MACHINE_SIZE) && Z_HOME_DIR < 0 && (!HAS_CUSTOM_PROBE_PIN || ENABLED(USE_PROBE_FOR_Z_HOMING))
...
#endif
#if defined(GRID_MAX_POINTS_X) || ENABLED(SW_MACHINE_SIZE)
